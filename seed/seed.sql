...
INSERT INTO customers (id, user_id, phone, phone_verified_at, loyalty_points, preferences) VALUES
  ('d1111111-1111-1111-1111-111111111111', 'd1111111-1111-1111-1111-111111111111', '+821012345678', NOW(), 100, '{"notifications": {"push": true, "sms": true}, "language": "ko"}'::jsonb),
  ('d2222222-2222-2222-2222-222222222222', 'd2222222-2222-2222-2222-222222222222', '+821098765432', NOW(), 50, '{"notifications": {"push": true, "sms": false}, "language": "ko"}'::jsonb);
