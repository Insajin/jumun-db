...
-- Note: user_id is NULL. Create users via Supabase Auth and update these records later
...
-- ============================================================================
-- CUSTOMERS (user_id set to NULL - update after creating auth users)
-- ============================================================================

INSERT INTO customers (id, user_id, phone, phone_verified_at, loyalty_points, preferences) VALUES
  ('d1111111-1111-1111-1111-111111111111', NULL, '+821012345678', NOW(), 100, '{"notifications": {"push": true, "sms": true}, "language": "ko"}'::jsonb),
  ('d2222222-2222-2222-2222-222222222222', NULL, '+821098765432', NOW(), 50, '{"notifications": {"push": true, "sms": false}, "language": "ko"}'::jsonb);
